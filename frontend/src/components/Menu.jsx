    ...
    <div className='mainMenu'>
      <div className='subMenu'>
        <span className='reviewsTags'>
          ...
          <span>
            <span className='totalReviews'>128</span>
            <span className='printReviews'>Reviews</span>
          </span>
          
        </span>
        <span className='qandA'>
          <span className='qandAIcon'>
            <ForumOutlinedIcon />
          </span>
          <span>
            <span className='totalQandA'>3</span>
            <span className='printQandA'>Q&A</span>
          </span>
        </span>
      </div>
    </div>
